        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 p-4 space-y-3">
              ...
              <div>
                {!isManual
                  ? <Btn variant="ghost" size="sm" onClick={() => sendCmd('manual')}>🔧 Modo manual</Btn>
                  : <Btn variant="ghost" size="sm" onClick={() => sendCmd('auto')}>🤖 Modo automático</Btn>
                }
              </div>
...
function PurifSensorCard({ label, value, unit, warn }) {
  return (
    <div className={`bg-white rounded-2xl border p-4 ${
      warn ? 'border-red-200 bg-red-50' : 'border-gray-100'
    }`}>
